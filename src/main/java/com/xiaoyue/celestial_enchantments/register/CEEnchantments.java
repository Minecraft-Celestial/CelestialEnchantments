...
public class CEEnchantments {
	...
	public static final RegistryEntry<Enchantment> TRAUMA_ABSORPTION = reg("trauma_absorption", TraumaAbsorption::new, "On hurt, restore [Enchantment Level] * 9% * damage you took");
	...
	public static final RegistryEntry<Enchantment> DEATH_BLADE = reg("death_blade", DeathBlade::new, "Increase [Enchantment Level] * 1% of the target's maximum health attack damage during attack");
	...
	public static final RegistryEntry<Enchantment> CORRUPTION_BODY = reg("corruption_body", CorruptionBody::new, "When attacked, reduces the attacker's armor by [Enchantment Level] * 3 for 1 minutes"); // TODO
	public static final RegistryEntry<Enchantment> CELESTIAL_SHELTER = reg("celestial_shelter", CelestialShelter::new, "When damaged, a single attack can only deal up to 25% of the wearer's maximum health");//TODO
	...
	public static final RegistryEntry<Enchantment> HEARTH_SUPPORT = reg("hearth_support", HearthSupport::new, "When attacked, burn attacker for [Enchantment Level] * 2 seconds");
	...
	public static final RegistryEntry<Enchantment> CORRUPT_SCHOLAR = reg("corrupt_scholar", CorruptScholar::new, "When picking up experience, increase it by [Enchantment Level] * 80%, but there is a [Enchantment Level] * 25% chance to gain negative effects");
	...
	public static final RegistryEntry<Enchantment> DESTRUCTION_CRACK = reg("destruction_crack", DestructionCrack::new, "On hit, remove invulnerable time on target for 1 minutes");//TODO
	...
	public static final RegistryEntry<Enchantment> SOLID_ARMOR = reg("solid_armor", SolidArmor::new, "When the wearer's health is less than half, the damage received is reduced by [Enchantment Level] * 3%");
	...
	public static final RegistryEntry<Enchantment> MISFORTUNE_BLADE = reg("misfortune_blade", MisfortuneBlade::new, "After attacking, poison target for 4 seconds. When the target is poisoned, increases attack damage by [Enchantment Level] * 25%");
	public static final RegistryEntry<Enchantment> FLEET_OF_FOOT = reg("fleet_of_foot", FleetOfFoot::new, "Increase [Enchantment Level] * 10% Movement Speed");
	public static final RegistryEntry<Enchantment> THE_SOURCE_OF_SIN = reg("the_source_of_sin", TheSourceOfSin::new, "When attacked, [Enchantment Level] * 20% chance to make surrounding mobs attack the attacker");
