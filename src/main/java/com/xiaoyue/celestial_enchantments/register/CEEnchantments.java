...
public class CEEnchantments {
	...
	public static final RegistryEntry<Enchantment> TRAUMA_ABSORPTION = reg("trauma_absorption", TraumaAbsorption::new, "On hurt, restore %s of lost health");//B
	// chest
	...
	// generic
	public static final RegistryEntry<Enchantment> BORN_IN_SHADOW = reg("born_in_shadow", BornInShadow::new, "In area with brightness less than %s, recover %s durability every %s seconds");
	// TODO photosynthesis
