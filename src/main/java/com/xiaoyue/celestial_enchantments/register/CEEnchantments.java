...
public class CEEnchantments {
	...
	public static final RegistryEntry<Enchantment> ECHO_EFFECT = reg("echo_effect", EchoEffect::new, "When receiving a deadly attack, block the damage and restore %s of maximum health. Cooldown: %s seconds");
	public static final RegistryEntry<Enchantment> ORIGIN_OF_LIFE = reg("origin_of_life", OriginOfLife::new, "When healed, there is a %s chance to gain %s or %s");
	...
	// legs
	public static final RegistryEntry<Enchantment> POTION_AFFINITY = reg("potion_affinity", PotionAffinity::new, "The duration of an obtained potion effect will by increased by %s");
	public static final RegistryEntry<Enchantment> PURE_BODY = reg("pure_body", PureBody::new, "Continuously clears potion effects from you");
